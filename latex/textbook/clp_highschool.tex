...
\end{align*}
Observe that, when $\gamma=\tfrac{\pi}{2}$, this reduces to, (surprise!)
...
\end{align*}
That is, the area of the circle is between 2 and 4 times the square of the radius. What is perhaps less obvious (if we had not been told this in school) is that the constant of proportionality for area is also $\pi$:
\begin{align*}
  \pi &= \frac{A}{r^2}.
\end{align*}
