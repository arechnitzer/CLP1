...
public class localMaxMinC extends Template {

     static {templateClass = new localMaxMinC() ; }

     public void setup() {
          filePrefix = "localMaxMinC" ;
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2.0 ;   
          ysize = 1.5 ;   
