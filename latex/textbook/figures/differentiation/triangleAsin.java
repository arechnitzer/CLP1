...
public class triangleAsin extends Template {

     static {templateClass = new triangleAsin() ; }

     public void setup() {
          filePrefix = "triangleAsin" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 3.0 ;      // in inches
          ysize = 1.2 ;   // in inches. 
     ...
     fTeXlabel(hyp*Math.cos(angle)/2, -4, "tc", "$\\sqrt{1-x^2}$") ;
