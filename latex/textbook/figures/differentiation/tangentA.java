...
public class tangentA extends Template {

     static {templateClass = new tangentA() ; }
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fTeXlabel( x1+0.02 , (y0+y1)/2.0, "cl", "$f(x_0+h)-f(x_0)$") ;
          fTeXlabel( x0 , -0.09 , "bc", "$x_0$") ;
          fTeXlabel( x1 , -0.09 , "bc", "$x_0+h$") ;
          fTeXlabel( -0.02 , y0, "rc", "$f(x_0)$") ;
          fTeXlabel( -0.02 , y1, "rc", "$f(x_0+h)$") ;
