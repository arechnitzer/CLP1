...
public class sinDeriv2 extends Template {

     static {templateClass = new sinDeriv2() ; }

     public void setup() {
          filePrefix = "sinDeriv2" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 1.5 ;      // in inches
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fTeXlabel(81*Math.cos(angle/2), 81*Math.sin(angle/2), "lc", "$h=0.4$") ;
