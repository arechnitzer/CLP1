...
\begin{defn}[Informal definition of limit]
  We write
\begin{align*}
  \lim_{x \to a} f(x) &= L
\end{align*}
...
\begin{theorem}[Limits of polynomials and rational functions]
...
\begin{defn}[Limits at infinity --- informal]
We write
\begin{align*}
...
\begin{defn}[The typical 3 pieces of a definition]
...
\begin{defn}[Limits at infinity --- formal]
