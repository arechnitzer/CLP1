...
\intertext{So there is a cancellation.
Hence the limit is}
...
\end{answer}
\begin{solution}
Since we can't plug in $t=\frac{1}{2}$, we'll simplify. One way to start is to add the fractions in the numerator. We'll need a common denominator, such as $3t^2(t^2-1)$.
\begin{align*}
