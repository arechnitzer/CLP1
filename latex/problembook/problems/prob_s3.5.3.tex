...
\Instructions{For Questions~\ref{s3.5.3firstderivfirst} and \ref{s3.5.3firstderivlast}, you  can decide whether a critical point is a local extremum by considering the derivative of the function.}
